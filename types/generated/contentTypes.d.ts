...
export interface ApiArtistArtist extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::artist.artist', 'nickname'> & Attribute.Required;
...
export interface ApiTrackTrack extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::track.track', 'title'> & Attribute.Required;
...
export interface ApiVacancyVacancy extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    type: Attribute.Enumeration<['Full-time', 'Remote', 'Hybrid']> &
      Attribute.Required &
